            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    <div className="lg:col-span-2 space-y-6">
                        {items.map((item) => (
                            <div
                                ...
                                className="bg-white p-6 rounded-3xl shadow-sm border border-khoi-lam/5 flex flex-col sm:flex-row gap-6 items-center"
                            >
                                <img
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3 bg-kem rounded-lg p-1 border border-khoi-lam/10">
                                        <button
                                            ...
                                            className="p-1 hover:bg-white rounded text-khoi-lam"
                                        >
                                    ...
                                    <button
                                        ...
                                        className="p-2 text-do-gach hover:bg-do-gach/10 rounded-lg transition-colors"
                                    >
                    ...
                    <div className="lg:col-span-1">
                      ...
                      -{((total * discount) / 100).toLocaleString('vi-VN')}đ
                    </span>
                                    </div>
                                )}
                                ...
                                <div className="flex justify-between border-t border-khoi-lam/10 pt-4">
                                    ...
                                    <span className="font-bold text-xl text-khoi-lam">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="bg-khoi-lam text-kem px-4 py-2 rounded-xl hover:bg-khoi-lam/90 transition-colors"
                                    >
                                        Áp dụng
                                    </button>
                                </div>
                                ...
                                {discount > 0 && (
                                    <p className="text-xanh-rung text-sm mt-2">
